...
zweitstimme <-  readxl::read_excel("DL_BE_BU2021.xlsx", 
                         sheet = "BE_W2")
...
# Checking CRS alignment
st_crs(dichte) == st_crs(bezirke)
st_crs(dichte) == st_crs(wahllokale)
```
...
# Comparing the distribution of the two density measures
